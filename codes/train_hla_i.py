...
# 1. 路径与超参数配置
# ==========================================
TRAIN_CSV = "/data1/gpj/AIDD/hla_epitope/data/HLA_I_epitope_train_shuffle.csv"
VAL_CSV   = "/data1/gpj/AIDD/hla_epitope/data/HLA_I_epitope_validation.csv"
SAVE_DIR  = "/data1/gpj/AIDD/hla_epitope/Advanced_baselines/checkpoints_lora"
os.makedirs(SAVE_DIR, exist_ok=True)

LOG_FILE = os.path.join(SAVE_DIR, "hlai_esm650_seed1.log")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if v_mcc > best_mcc:
            best_mcc = v_mcc
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, "hlai_esm650_seed1.pth"))
            logging.info(f"[🚀] New SOTA Model saved! (MCC: {best_mcc:.4f})")
